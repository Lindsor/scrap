  ...
  .forEach((userName: string) => {
    ...
    [
      ...
      },
      {
        ...
        body: [
          {
            "props": `{${userName}AlertSubscriptionsGet.responseBody.data[0].props}::object`,
            ...
            "deliveryTarget": `{${userName}AlertSubscriptionsGet.responseBody.data[0].deliveryTarget}::object`,
      ...
      },
      {
        ...
        headers: {},
        query: {
          startDate: '2019-01-15T18:00:00.000Z',
          endDate: '2019-01-16T19:00:00.000Z',
          customerId: `{${customerId}}`,
        },
      },
      {
    ...
    [0, 1, 2]
      .reduce((arr: any[], accountIndex) => {

        const accountId: string = `${userName}AccountsGet.responseBody.data[0].accounts[${accountIndex}].accountId`;

        arr.push({
          id: `${userName}AccountDetailsGet[${accountIndex}]`,
          url: `/banking/bhobssa/www/api/us-banking/admin/customer/{${customerId}}/account/{${accountId}}`,
          method: 'GET',
          body: undefined,
          headers: {},
          query: undefined,
        ...
        arr.push({
          id: `${userName}TransactionsGet[${accountIndex}]`,
          url: `/banking/bhobssa/www/api/us-banking/transaction/agent/{${customerId}}/accounts/{${accountId}}/transactions`,
          method: 'GET',
          body: undefined,
          headers: {},
          query: {
        ...
        arr.push({
          id: `${userName}StatementsGet[${accountIndex}]`,
          url: `/banking/bhobssa/www/api/us-banking/statement/agent/customers/{${customerId}}/accounts/{${accountId}}/statements`,
          method: 'GET',
          body: undefined,
          headers: {},
          // query: {
          //   startSate: `2018-11-01T19:00:00.000Z`,
          //   endDate: `2018-11-31T19:00:00.000Z`
          // },
        });

        arr.push({
          id: `${userName}EntitlementsGet[${accountIndex}]`,
          url: `/banking/bhobssa/www/api/us-banking/admin/customer/{${customerId}}/accounts/{${accountId}}/entitlement`,
          method: 'GET',
          body: undefined,
          headers: {},
          query: undefined,
